...
public struct CalendarHeaderView: CalendarHeaderViewable {
    public let context: any CalendarHeaderContextRepresentable

    public init(context: any CalendarHeaderContextRepresentable) {
